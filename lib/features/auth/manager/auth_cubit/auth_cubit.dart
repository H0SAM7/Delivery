...
import 'package:delivery/core/error/firebase_failure.dart';
import 'package:delivery/core/utils/auth_helper.dart';
      ...
      if (user != null) {
        ...
        if (eVerified) {
          await FirebaseFirestore.instance
            ...
            String jsonString = jsonEncode({'email':email,'username':userName});
